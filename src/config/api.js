...
export const API_ROUTES = {
  ...
  createSubscribe: '/api/v1/subscribe/create/pending',
}
...
export const TELEGRAM_BOT_NAME = 'don_weather_bot'
export const TELEGRAM_URL_BASE = 'https://t.me/'
export const TELEGRAM_URL = TELEGRAM_URL_BASE + TELEGRAM_BOT_NAME
